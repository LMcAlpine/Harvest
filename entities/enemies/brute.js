...
class Brute {
    constructor(game) {
        ...
        this.game = game;
        this.state = 0;
        this.SpriteSheet = ASSET_MANAGER.getAsset("./sprites/brute.png");
        this.animations = [];
    ...
    loadAnimations() {
        ...
        // idle
        this.gunAnimations[0] = new Animator(this.brute, 0, 0, 64, 64, 8, 0.095, 0, false, true);

        // Walk
        this.gunAnimations[1] = new Animator(this.brute, 0, 64, 64, 64, 8, 0.095, 0, false, true);
